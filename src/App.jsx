...
import { store } from './services/Reduces/redux.ts';
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route
          path="/lagerhalter/Lagerplatzreservierung"
          element={<Lagerplatzreservierung />}
        />
        <Route
          path="/lagerhalter/Beantragte_Services"
          element={<Beantragte_Services />}
        />
        <Route path="/lagerhalter/termine" element={<Termine />} />

        <Route path="/autobesitzer/autosA" element={<Auto />} />
        <Route
          path="/autobesitzer/Lagerplaetze_suchen"
          element={<Lagerplaetze_suchen />}
        />
        <Route
          path="/autobesitzer/Beantragte_Lagerplaetze"
          element={<Beantragte_Lagerplaetze />}
        />
        <Route
          path="/autobesitzer/Beantragte_Services"
          element={<Beantragte_ServicesA />}
        />
